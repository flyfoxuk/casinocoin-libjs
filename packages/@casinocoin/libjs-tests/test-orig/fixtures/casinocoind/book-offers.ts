...
const requestBookOffersBidsResponse = (request: any, options: any = {}) => {
  _.defaults(options, {
    gets: {
      currency: "USD",
...
const requestBookOffersBidsPartialFundedResponse = (request: any, options: any = {}) => {
  _.defaults(options, {
    gets: {
      currency: "BTC",
      issuer: "rvYAfWj5gh67oV6fW32ZzP3Aw4Eubs59B",
...
const requestBookOffersAsksPartialFundedResponse = (request: any, options: any = {}) => {
...
const requestBookOffersAsksResponse = (request: any, options: any = {}) => {
  _.defaults(options, {
    pays: {
      currency: "USD",
      issuer: "rvYAfWj5gh67oV6fW32ZzP3Aw4Eubs59B",
...
const requestBookOffersCSCBaseResponse = (request: any) => {
  return JSON.stringify({
    id: request.id,
    status: "success",
    type: "response",
...
const requestBookOffersCSCCounterResponse = (request: any) => {
  return JSON.stringify({
    id: request.id,
    status: "success",
    type: "response",
...
export {
  requestBookOffersCSCBaseResponse,
  requestBookOffersCSCCounterResponse,
  requestBookOffersAsksPartialFundedResponse,
  requestBookOffersAsksResponse,
  requestBookOffersBidsResponse,
  requestBookOffersBidsPartialFundedResponse,
};
