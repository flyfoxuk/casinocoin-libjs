...
const errors = require('../../dist/npm/common/errors');
...
const {isValidSecret} = require('../../dist/npm/common');
...
function setup(server = 'wss://ws01.casinocoin.org') {
...
function setupAccounts(testcase) {
  ...
  const promise = payTo(api, 'cEe3dBYFwGEZ385ogF5ALyDtpp4R4aQuWx')
    ...
    .then(() => payTo(api, 'cDEDNoEfjywwdyGNgPXXsQ679iYoA8Lm6G'))
    .then(() => {
  ...
  it('order', function() {
    const orderSpecification = {
      ...
      quantity: {
        currency: 'USD',
        value: '237',
        counterparty: 'cDEDNoEfjywwdyGNgPXXsQ679iYoA8Lm6G'
      },
      totalPrice: {
        currency: 'CSC',
        value: '0.0002'
