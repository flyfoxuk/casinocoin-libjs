...
module.exports = function(request, options = {}) {
  ...
  let tx = {
    ...
    Paths: [
      [
        {
          currency: 'USD',
          issuer: testAccount.COUNTERPARTY,
          type: 48,
          type_hex: '0000000000000030'
        },
        {
          account: testAccount.COUNTERPARTY,
          currency: 'USD',
          issuer: testAccount.COUNTERPARTY,
          type: 49,
    ...
    AffectedNodes: [
      ...
      },
      {
        ModifiedNode: {
          ...
          PreviousTxnLgrSeq: 22592
        }
      },
      {
        ModifiedNode: {
          FinalFields: {
            Account: 'cPpbK2qLqCfEAjkrFGuMhD8zZ7bHKXx8Gb',
      ...
      },
      {
        ModifiedNode: {
          FinalFields: {
            ...
            HighLimit: {
              currency: 'USD',
              issuer: 'cPpbK2qLqCfEAjkrFGuMhD8zZ7bHKXx8Gb',
              value: '1000'
            },
            HighNode: '0000000000000000',
            LowLimit: {
  ...
  if (marker === 5) {
    ...
    tx.Account = testAccount.COUNTERPARTY;
  } else if (marker === 8) {
    ...
    tx.Destination = testAccount.ACCOUNT;
  }
  if (request.limit === 13) {
  ...
  return JSON.stringify({
    ...
    result: {
      ...
      transactions: [
        {
          ledger_index: 22594 - Number(marker || 100),
