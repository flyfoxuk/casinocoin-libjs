...
module.exports = {
  ...
  ledger: {
    ...
    ledger_20: require('./ledger-full-20'),
  ...
  account_info: {
    ...
    account_lines_test_account: require('./account_lines_test_account'),
    normalTestAccount: require('./account-info-testaccount'),
  ...
  account_tx: {
    ...
    test_account: require('./get-transactions'),
    test_account_earliestfirst: require('./get-transactions-earliestfirst')
  },
  ...
  tx: {
    ...
    PaymentSecond: require('./tx/payment-second.json'),
