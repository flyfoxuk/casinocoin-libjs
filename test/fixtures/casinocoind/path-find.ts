const generateIOUPaymentPaths =
  (requestId: number, sendingAccount: any, destinationAccount: any, destinationAmount: any) => {
...
const generateCSCPaymentPaths =
  (requestId: any, sendingAccount: any, destinationAccount: any) => {
    return JSON.stringify({
      id: requestId,
      status: "success",
      type: "response",
